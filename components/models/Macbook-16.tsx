...
Files: macbook-16.glb [639.28KB] > C:\Users\DELL\Desktop\applelanding\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props:React.ComponentPropsWithoutRef<'group'>) {
  const { nodes, materials } = useGLTF('/models/macbook-16-transformed.glb') as unknown as {
